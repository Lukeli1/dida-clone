    ...
    <div className="flex-1 overflow-y-auto bg-[var(--color-bg-secondary)] p-6">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            <h2 className="text-2xl font-bold text-[var(--color-text-primary)]">目标 / OKR</h2>
        ...
        {loading || !secondaryDataLoaded ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <p className="text-[15px] font-semibold text-[var(--color-text-secondary)]">暂无目标</p>
            <p className="text-sm text-[var(--color-text-tertiary)] mt-1.5 max-w-xs">
              创建年度 / 季度 / 月度目标，关联任务并跟踪完成进度
            </p>
          </div>
        ) : (
          <>
