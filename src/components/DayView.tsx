    ...
    <div className="flex flex-col h-full dark:bg-gray-900">
      <div className="flex items-center justify-between px-4 py-3 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900">
        <div className="flex items-center gap-2">
          <button onClick={onPrevDay} className="p-1.5 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors">
          ...
          <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 min-w-[140px] text-center">
            {format(currentDate, 'M月d日 EEEE', { locale: zhCN })}
          </h3>
          <button onClick={onNextDay} className="p-1.5 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors">
      ...
      <div className="flex-1 overflow-y-auto select-none">
        <div className="flex">
          ...
          <div className="flex-1">
            <div onClick={() => onDateClick(currentDate)} className={`h-12 border-b border-gray-200 dark:border-gray-700 flex items-center justify-center cursor-pointer hover:bg-blue-50/50 dark:hover:bg-blue-900/20 transition-colors ${today ? 'bg-blue-50 dark:bg-blue-900/30' : ''}`}>
              <span className={`text-sm font-medium ${today ? 'w-6 h-6 flex items-center justify-center bg-blue-500 text-white rounded-full' : 'text-gray-700 dark:text-gray-200'}`}>
