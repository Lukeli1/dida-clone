      ...
      <div className="flex items-center gap-1 px-3 py-1.5">
        ...
        >
          <svg className="w-4 h-4" viewBox="0 0 24 24">
            <circle cx="12" cy="12" r="8" fill="var(--color-priority-high)" />
          </svg>
        ...
        >
          <svg className="w-4 h-4" viewBox="0 0 24 24">
            <circle cx="12" cy="12" r="8" fill="var(--color-priority-medium)" />
          </svg>
        ...
        >
          <svg className="w-4 h-4" viewBox="0 0 24 24">
            <circle cx="12" cy="12" r="8" fill="var(--color-priority-low)" />
          </svg>
        ...
        >
          <svg className="w-4 h-4" viewBox="0 0 24 24">
            <circle cx="12" cy="12" r="7" fill="none" stroke="var(--color-priority-none)" strokeWidth="2" />
          </svg>
