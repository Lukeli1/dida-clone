  ...
  return (
    <>
      ...
      <div onMouseEnter={handleEnter} onMouseLeave={handleLeave} className="relative">
        ...
        {showTagSubmenu && (
          <div
            className="absolute left-full top-0 ml-0.5 bg-[var(--color-surface)] rounded-lg border border-[var(--color-border)] py-1 w-44"
            ...
            {tags.map((tag) => {
              ...
              return (
                ...
                >
                  ...
                  <span
                    className={`truncate ${isSelected ? 'text-[var(--color-text-primary)] font-medium' : 'text-[var(--color-text-secondary)]'}`}
                  >
                    {tag.name}
                  </span>
                </button>
