      ...
      >
        ...
        <div className="flex items-start gap-3 mb-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-[var(--color-text-secondary)] mt-1 leading-relaxed">{conflict.message}</p>
          </div>
          <button
            onClick={handleClose}
            disabled={resolving}
        ...
        <div className="space-y-2.5 mb-4">
          <p className="text-xs font-medium text-[var(--color-text-secondary)] mb-2">请选择冲突解决方式：</p>
